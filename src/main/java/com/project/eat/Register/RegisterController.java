...
public class RegisterController {
    ...
    public String insertOK(RegisterVO_JPA vo) {
        log.info("/member/insertOK..."); // "/member/insertOK..." 메시지를 로그에 기록합니다.
        ...
        if (result != null) { // 저장 결과가 null이 아니면
            return "redirect:/"; // 모든 회원 정보를 조회하는 페이지로 리다이렉트합니다. /
        } else { // 그렇지 않으면
            return "redirect:insert"; // 회원 등록 페이지로 리다이렉트합니다.
        }
    }
