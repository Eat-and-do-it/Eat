...
public class RegisterRestController {
    ...
    @PostMapping("/m_insertOK") //주석 해제
    public String m_insertOK(RegisterVO_JPA vo) {
        log.info("/m_insertOK...");
        log.info("vo:{}", vo);

        RegisterVO_JPA result = service.insertOK(vo);
    ...
    @GetMapping("/api/member/selectAll")
    public Map<String, Object>  m_selectAll(@RequestParam(defaultValue = "1") int cpage,
                                            @RequestParam(defaultValue = "5") int pageBlock) {
        log.info("/api/member/selectAll...");
